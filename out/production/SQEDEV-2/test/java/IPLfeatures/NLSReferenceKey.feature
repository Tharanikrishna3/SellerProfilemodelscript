Feature: NLS Reference Key Page verification
...
Background:
      ...
      Then Navigate to NLS Reference Key PAGE
      
	@Scenario1ipl
  Scenario: Verify NLS Reference Key page having all the fields all list_grid_card views
