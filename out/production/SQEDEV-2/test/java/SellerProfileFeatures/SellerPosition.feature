Feature: Sales Role Tag value Page verification
  ...
  Scenario: Verify Sales Role tag value page having all the fields in list/card/grid/view/ViewHistory views
    Then user checks data on List Screen in salesroletagvalue "seller","First date on plan","Status"
    Then user checks data on Card Screen in salesroletagvalue "seller","First date on plan","Status"
    Then user checks data on Grid Screen in salesroletagvalue "seller","First date on plan","Status"
    Then user checks data on View Screen in salesroletagvalue "seller","First date on plan","Status"
    Then user checks data on View History Screen in salesroletagvalue "seller","First date on plan","Status"
  ...
  And user provides all required inputs in salesroletagvalue "<seller>""<First date on plan>""<Status>"
  ...
  Examples:
|seller|First date on plan|Status|
||
