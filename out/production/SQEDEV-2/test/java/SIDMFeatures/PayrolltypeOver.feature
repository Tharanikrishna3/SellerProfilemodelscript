Feature: Payroll Type Over verification
...
Background:
      ...
      Then Navigate to Payroll Type Over Page
      
	@Scenario1ipl
  Scenario: Verify Payroll Type Over page having all the fields all list_grid_card views
    ...
    @Scenario2ipl
  Scenario Outline: Verify Add Edit working fine in Payroll Type Over page
