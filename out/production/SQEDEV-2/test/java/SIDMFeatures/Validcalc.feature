Feature: Valid Calc Page verification

Background:
      Given User navigates to Home page ""
    	Then Login into application with the id "anacst@br.ibm.com","123"
      Then Navigate to Valid Calc page
      
	@Scenario1sm
  Scenario: Verify Valid Calc page having all the fields all list_grid_card views
    And Check view having all the below fields
		| Calculation basis  |   Calculation type  |   Start date |  End date  |  Status  |
  ...
  Then add new record in Valid Calc page with below values "<Calc_basis>""<Calc_type>""<Effective_Date>""<Delete_Date>"
  ...
  Examples:
	| Calc_basis  |   Calc_type  |  Effective_Date  | Delete_Date  |
